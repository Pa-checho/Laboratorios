...
ISR_BOTON_ABRIR:
    ...
    ; Ignorar si la puerta ya esta completamente abierta.
    sbic PORTB, PORTB0
...
ISR_BOTON_CERRAR:
    ...
    ; Ignorar si la puerta ya esta completamente cerrada.
    sbic PORTB, PORTB1
...
;===========================================================
; INTERRUPCION DEL BOTON OBSTACULO
;===========================================================
